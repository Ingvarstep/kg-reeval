...
def parse_args():
	...
	args.add_argument("-outfolder", "--output_folder", default="./checkpoints/wn/out/", help="Folder name to save the models.")

	args.add_argument("-eval_type", "--eval_type", default='last')
	# arguments for GAT
	args.add_argument("-b_gat", "--batch_size_gat", type=int, default=86835, help="Batch size for GAT")
